...
export const messages = {
  en: {
    ...
    fixed: "Fixed",
    fixedBody: "This machine has been repaired.",
    reviewed: "Reviewed",
    reviewedBody: "Thanks — the team has reviewed your report.",
    // dead link (§7.4)
  ...
  bg: {
    ...
    fixed: "Отстранено",
    fixedBody: "Машината е ремонтирана.",
    reviewed: "Прегледано",
    reviewedBody: "Благодарим — екипът прегледа доклада ви.",
